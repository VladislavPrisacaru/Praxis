    ...
    public partial class CreateWarehouse : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    WarehouseRef = table.Column<string>(type: "nvarchar(8)", maxLength: 8, nullable: false),
                    ...
                    TypeOfWarehouse = table.Column<int>(type: "int", nullable: false),
                    IsDefault = table.Column<bool>(type: "bit", nullable: false),
                    Notes = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedBy = table.Column<string>(type: "nvarchar(16)", maxLength: 16, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Warehouses", x => x.WarehouseRef);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Warehouses_WarehouseRef",
                schema: "Admin",
                table: "Warehouses",
                column: "WarehouseRef",
                unique: true);
